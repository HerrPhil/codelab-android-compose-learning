...
private fun AlertCard() {
    ...
    // Here is the buggy animation that breaks the test
...
//    )
    ...
    // Here is the infinite animation that is test-friendly
    val infiniteAnimationElevation = rememberInfiniteTransition()
    val animatedElevationInfinitely: Dp by infiniteAnimationElevation.animateValue(
        initialValue = 1.dp,
        targetValue = 8.dp,
...
//    Card(elevation = animatedElevation.value) {
    Card(elevation = animatedElevationInfinitely) {
        Column {
            AlertHeader {
                showDialog = true
            }
