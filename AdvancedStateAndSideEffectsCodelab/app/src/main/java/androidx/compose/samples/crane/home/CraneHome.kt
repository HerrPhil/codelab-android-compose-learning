    ...
    Scaffold(
        ...
        CraneHomeContent(
            ...
            openDrawer = {
                ...
                // in the Composition where you call it. The scope will be automatically canceled
                // once it leaves the Composition. With that scope, you can start coroutines when
                // you're not in the Composition, for example, in the openDrawer callback.
...
//    val suggestedDestinations: List<ExploreModel> = remember { emptyList() }
    // Lesson: Replace with the state-aware call that reads state value and recomposes on new emissions
